...
// microVU test harness — exercises the namespaced Phase-7 ARM64 VU JIT.
...
void mVU0_TestExec(u32 startPC, u32 cycles)
{
	...
	pcsx2_macrec::CpuMicroVU0.Execute(cycles);
}

void mVU1_TestInit()
{
	pcsx2_macrec::CpuMicroVU1.Reserve();
	pcsx2_macrec::CpuMicroVU1.Reset();
}
...
void mVU1_TestExec(u32 startPC, u32 cycles)
{
	...
	pcsx2_macrec::CpuMicroVU1.Execute(cycles);
}
